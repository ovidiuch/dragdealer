...
jasmine.HtmlReporter.ReporterView = function(dom) {
  ...
  this.complete = function() {
    if (this.failedCount === 0) {
      ...
      dom.alert.appendChild(this.createDom('span', {className: 'failingAlert bar'}, "Failing " + specPluralizedFor(this.failedCount)));
    }
    var duration = ((new Date().getTime() - this.startedAt.getTime()) / 1000);
    $(dom.banner).append('<span class="duration"><a href="https://github.com/pivotal/jasmine"><i class="fa fa-clock-o"></i> ' + duration + 's</a></span>');
  };
...
jasmine.HtmlReporter.SpecView.prototype.appendFailureDetail = function() {
  ...
  if (messagesDiv.childNodes.length > 0) {
    this.summary.appendChild(messagesDiv);
  }
};
...
jasmine.HtmlReporterHelpers.addHelpers(jasmine.HtmlReporter.SpecView);jasmine.HtmlReporter.SuiteView = function(suite, dom, views) {
  ...
  this.element = this.createDom('div', { className: 'suite' },
    this.createDom('div', { className: 'specTitle' },
      this.createDom('a', {
        className: 'description',
